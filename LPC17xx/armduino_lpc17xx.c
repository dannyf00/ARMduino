...
//#include "armduino_lpc17xx.h"						//we use aruidno GPIO port for stm32F
...
const PIN2GPIO GPIO_PinDef[]={
		{LPC_GPIO0, 1<< 0},						//ARMduino Pin  0 = PA0
		{LPC_GPIO0, 1<< 1},						//ARMduino Pin  1 = PA1
		{LPC_GPIO0, 1<< 2}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO0, 1<< 3},						//ARMduino Pin  3 = PA3
		{LPC_GPIO0, 1<< 4},						//ARMduino Pin  4 = PA4
		{LPC_GPIO0, 1<< 5},						//ARMduino Pin  5 = PA5
		{LPC_GPIO0, 1<< 6},						//ARMduino Pin  6 = PA6
		{LPC_GPIO0, 1<< 7},						//ARMduino Pin  7 = PA7
		{LPC_GPIO0, 1<< 8},						//ARMduino Pin  8 = PA8
		{LPC_GPIO0, 1<< 9},						//ARMduino Pin  9 = PA9
		{LPC_GPIO0, 1<<10},						//ARMduino Pin 10 = PA10
		{LPC_GPIO0, 1<<11},						//ARMduino Pin 11 = PA11
		{LPC_GPIO0, 1<<12},						//ARMduino Pin 12 = PA12
		{LPC_GPIO0, 1<<13},						//ARMduino Pin 13 = PA13
		{LPC_GPIO0, 1<<14},						//ARMduino Pin 14 = PA14
		{LPC_GPIO0, 1<<15},						//ARMduino Pin 15 = PA15
		{LPC_GPIO0, 1<<16},						//ARMduino Pin  0 = PA0
		{LPC_GPIO0, 1<<17},						//ARMduino Pin  1 = PA1
		{LPC_GPIO0, 1<<18}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO0, 1<<19},						//ARMduino Pin  3 = PA3
		{LPC_GPIO0, 1<<20},						//ARMduino Pin  4 = PA4
		{LPC_GPIO0, 1<<21},						//ARMduino Pin  5 = PA5
		{LPC_GPIO0, 1<<22},						//ARMduino Pin  6 = PA6
		{LPC_GPIO0, 1<<23},						//ARMduino Pin  7 = PA7
		{LPC_GPIO0, 1<<24},						//ARMduino Pin  8 = PA8
		{LPC_GPIO0, 1<<25},						//ARMduino Pin  9 = PA9
		{LPC_GPIO0, 1<<26},						//ARMduino Pin 10 = PA10
		{LPC_GPIO0, 1<<27},						//ARMduino Pin 11 = PA11
		{LPC_GPIO0, 1<<28},						//ARMduino Pin 12 = PA12
		{LPC_GPIO0, 1<<29},						//ARMduino Pin 13 = PA13
		{LPC_GPIO0, 1<<30},						//ARMduino Pin 14 = PA14
		{LPC_GPIO0, 1<<31},						//ARMduino Pin 15 = PA15
	
		{LPC_GPIO1, 1<< 0},						//ARMduino Pin  0 = PA0
		{LPC_GPIO1, 1<< 1},						//ARMduino Pin  1 = PA1
		{LPC_GPIO1, 1<< 2}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO1, 1<< 3},						//ARMduino Pin  3 = PA3
		{LPC_GPIO1, 1<< 4},						//ARMduino Pin  4 = PA4
		{LPC_GPIO1, 1<< 5},						//ARMduino Pin  5 = PA5
		{LPC_GPIO1, 1<< 6},						//ARMduino Pin  6 = PA6
		{LPC_GPIO1, 1<< 7},						//ARMduino Pin  7 = PA7
		{LPC_GPIO1, 1<< 8},						//ARMduino Pin  8 = PA8
		{LPC_GPIO1, 1<< 9},						//ARMduino Pin  9 = PA9
		{LPC_GPIO1, 1<<10},						//ARMduino Pin 10 = PA10
		{LPC_GPIO1, 1<<11},						//ARMduino Pin 11 = PA11
		{LPC_GPIO1, 1<<12},						//ARMduino Pin 12 = PA12
		{LPC_GPIO1, 1<<13},						//ARMduino Pin 13 = PA13
		{LPC_GPIO1, 1<<14},						//ARMduino Pin 14 = PA14
		{LPC_GPIO1, 1<<15},						//ARMduino Pin 15 = PA15
		{LPC_GPIO1, 1<<16},						//ARMduino Pin  0 = PA0
		{LPC_GPIO1, 1<<17},						//ARMduino Pin  1 = PA1
		{LPC_GPIO1, 1<<18}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO1, 1<<19},						//ARMduino Pin  3 = PA3
		{LPC_GPIO1, 1<<20},						//ARMduino Pin  4 = PA4
		{LPC_GPIO1, 1<<21},						//ARMduino Pin  5 = PA5
		{LPC_GPIO1, 1<<22},						//ARMduino Pin  6 = PA6
		{LPC_GPIO1, 1<<23},						//ARMduino Pin  7 = PA7
		{LPC_GPIO1, 1<<24},						//ARMduino Pin  8 = PA8
		{LPC_GPIO1, 1<<25},						//ARMduino Pin  9 = PA9
		{LPC_GPIO1, 1<<26},						//ARMduino Pin 10 = PA10
		{LPC_GPIO1, 1<<27},						//ARMduino Pin 11 = PA11
		{LPC_GPIO1, 1<<28},						//ARMduino Pin 12 = PA12
		{LPC_GPIO1, 1<<29},						//ARMduino Pin 13 = PA13
		{LPC_GPIO1, 1<<30},						//ARMduino Pin 14 = PA14
		{LPC_GPIO1, 1<<31},						//ARMduino Pin 15 = PA15
	
		{LPC_GPIO2, 1<< 0},						//ARMduino Pin  0 = PA0
		{LPC_GPIO2, 1<< 1},						//ARMduino Pin  1 = PA1
		{LPC_GPIO2, 1<< 2}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO2, 1<< 3},						//ARMduino Pin  3 = PA3
		{LPC_GPIO2, 1<< 4},						//ARMduino Pin  4 = PA4
		{LPC_GPIO2, 1<< 5},						//ARMduino Pin  5 = PA5
		{LPC_GPIO2, 1<< 6},						//ARMduino Pin  6 = PA6
		{LPC_GPIO2, 1<< 7},						//ARMduino Pin  7 = PA7
		{LPC_GPIO2, 1<< 8},						//ARMduino Pin  8 = PA8
		{LPC_GPIO2, 1<< 9},						//ARMduino Pin  9 = PA9
		{LPC_GPIO2, 1<<10},						//ARMduino Pin 10 = PA10
		{LPC_GPIO2, 1<<11},						//ARMduino Pin 11 = PA11
		{LPC_GPIO2, 1<<12},						//ARMduino Pin 12 = PA12
		{LPC_GPIO2, 1<<13},						//ARMduino Pin 13 = PA13
		{LPC_GPIO2, 1<<14},						//ARMduino Pin 14 = PA14
		{LPC_GPIO2, 1<<15},						//ARMduino Pin 15 = PA15
		{LPC_GPIO2, 1<<16},						//ARMduino Pin  0 = PA0
		{LPC_GPIO2, 1<<17},						//ARMduino Pin  1 = PA1
		{LPC_GPIO2, 1<<18}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO2, 1<<19},						//ARMduino Pin  3 = PA3
		{LPC_GPIO2, 1<<20},						//ARMduino Pin  4 = PA4
		{LPC_GPIO2, 1<<21},						//ARMduino Pin  5 = PA5
		{LPC_GPIO2, 1<<22},						//ARMduino Pin  6 = PA6
		{LPC_GPIO2, 1<<23},						//ARMduino Pin  7 = PA7
		{LPC_GPIO2, 1<<24},						//ARMduino Pin  8 = PA8
		{LPC_GPIO2, 1<<25},						//ARMduino Pin  9 = PA9
		{LPC_GPIO2, 1<<26},						//ARMduino Pin 10 = PA10
		{LPC_GPIO2, 1<<27},						//ARMduino Pin 11 = PA11
		{LPC_GPIO2, 1<<28},						//ARMduino Pin 12 = PA12
		{LPC_GPIO2, 1<<29},						//ARMduino Pin 13 = PA13
		{LPC_GPIO2, 1<<30},						//ARMduino Pin 14 = PA14
		{LPC_GPIO2, 1<<31},						//ARMduino Pin 15 = PA15
	
		{LPC_GPIO3, 1<< 0},						//ARMduino Pin  0 = PA0
		{LPC_GPIO3, 1<< 1},						//ARMduino Pin  1 = PA1
		{LPC_GPIO3, 1<< 2}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO3, 1<< 3},						//ARMduino Pin  3 = PA3
		{LPC_GPIO3, 1<< 4},						//ARMduino Pin  4 = PA4
		{LPC_GPIO3, 1<< 5},						//ARMduino Pin  5 = PA5
		{LPC_GPIO3, 1<< 6},						//ARMduino Pin  6 = PA6
		{LPC_GPIO3, 1<< 7},						//ARMduino Pin  7 = PA7
		{LPC_GPIO3, 1<< 8},						//ARMduino Pin  8 = PA8
		{LPC_GPIO3, 1<< 9},						//ARMduino Pin  9 = PA9
		{LPC_GPIO3, 1<<10},						//ARMduino Pin 10 = PA10
		{LPC_GPIO3, 1<<11},						//ARMduino Pin 11 = PA11
		{LPC_GPIO3, 1<<12},						//ARMduino Pin 12 = PA12
		{LPC_GPIO3, 1<<13},						//ARMduino Pin 13 = PA13
		{LPC_GPIO3, 1<<14},						//ARMduino Pin 14 = PA14
		{LPC_GPIO3, 1<<15},						//ARMduino Pin 15 = PA15
		{LPC_GPIO3, 1<<16},						//ARMduino Pin  0 = PA0
		{LPC_GPIO3, 1<<17},						//ARMduino Pin  1 = PA1
		{LPC_GPIO3, 1<<18}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO3, 1<<19},						//ARMduino Pin  3 = PA3
		{LPC_GPIO3, 1<<20},						//ARMduino Pin  4 = PA4
		{LPC_GPIO3, 1<<21},						//ARMduino Pin  5 = PA5
		{LPC_GPIO3, 1<<22},						//ARMduino Pin  6 = PA6
		{LPC_GPIO3, 1<<23},						//ARMduino Pin  7 = PA7
		{LPC_GPIO3, 1<<24},						//ARMduino Pin  8 = PA8
		{LPC_GPIO3, 1<<25},						//ARMduino Pin  9 = PA9
		{LPC_GPIO3, 1<<26},						//ARMduino Pin 10 = PA10
		{LPC_GPIO3, 1<<27},						//ARMduino Pin 11 = PA11
		{LPC_GPIO3, 1<<28},						//ARMduino Pin 12 = PA12
		{LPC_GPIO3, 1<<29},						//ARMduino Pin 13 = PA13
		{LPC_GPIO3, 1<<30},						//ARMduino Pin 14 = PA14
		{LPC_GPIO3, 1<<31},						//ARMduino Pin 15 = PA15
	
		{LPC_GPIO4, 1<< 0},						//ARMduino Pin  0 = PA0
		{LPC_GPIO4, 1<< 1},						//ARMduino Pin  1 = PA1
		{LPC_GPIO4, 1<< 2}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO4, 1<< 3},						//ARMduino Pin  3 = PA3
		{LPC_GPIO4, 1<< 4},						//ARMduino Pin  4 = PA4
		{LPC_GPIO4, 1<< 5},						//ARMduino Pin  5 = PA5
		{LPC_GPIO4, 1<< 6},						//ARMduino Pin  6 = PA6
		{LPC_GPIO4, 1<< 7},						//ARMduino Pin  7 = PA7
		{LPC_GPIO4, 1<< 8},						//ARMduino Pin  8 = PA8
		{LPC_GPIO4, 1<< 9},						//ARMduino Pin  9 = PA9
		{LPC_GPIO4, 1<<10},						//ARMduino Pin 10 = PA10
		{LPC_GPIO4, 1<<11},						//ARMduino Pin 11 = PA11
		{LPC_GPIO4, 1<<12},						//ARMduino Pin 12 = PA12
		{LPC_GPIO4, 1<<13},						//ARMduino Pin 13 = PA13
		{LPC_GPIO4, 1<<14},						//ARMduino Pin 14 = PA14
		{LPC_GPIO4, 1<<15},						//ARMduino Pin 15 = PA15
		{LPC_GPIO4, 1<<16},						//ARMduino Pin  0 = PA0
		{LPC_GPIO4, 1<<17},						//ARMduino Pin  1 = PA1
		{LPC_GPIO4, 1<<18}, 					//ARMduino Pin  2 = PA2
		{LPC_GPIO4, 1<<19},						//ARMduino Pin  3 = PA3
		{LPC_GPIO4, 1<<20},						//ARMduino Pin  4 = PA4
		{LPC_GPIO4, 1<<21},						//ARMduino Pin  5 = PA5
		{LPC_GPIO4, 1<<22},						//ARMduino Pin  6 = PA6
		{LPC_GPIO4, 1<<23},						//ARMduino Pin  7 = PA7
		{LPC_GPIO4, 1<<24},						//ARMduino Pin  8 = PA8
		{LPC_GPIO4, 1<<25},						//ARMduino Pin  9 = PA9
		{LPC_GPIO4, 1<<26},						//ARMduino Pin 10 = PA10
		{LPC_GPIO4, 1<<27},						//ARMduino Pin 11 = PA11
		{LPC_GPIO4, 1<<28},						//ARMduino Pin 12 = PA12
		{LPC_GPIO4, 1<<29},						//ARMduino Pin 13 = PA13
		{LPC_GPIO4, 1<<30},						//ARMduino Pin 14 = PA14
		{LPC_GPIO4, 1<<31},						//ARMduino Pin 15 = PA15
...
inline void pinMode(PIN_TypeDef pin, uint8_t mode) {
	...
	switch (mode) {
	case INPUT: 		GIO_IN(GPIO_PinDef[pin].gpio, GPIO_PinDef[pin].mask); break;			//floating input
	//case INPUT_PULLUP: 	GIO_IN(GPIO_PinDef[pin].gpio, GPIO_PinDef[pin].mask); GIO_SET(GPIO_PinDef[pin].gpio, GPIO_PinDef[pin].mask); break;			//input with pullup
	...
	case OUTPUT:		GIO_OUT(GPIO_PinDef[pin].gpio, GPIO_PinDef[pin].mask); break;			//floating input
...
void chip_init(void) {
	...
	LPC_SC->PCONP |= (1<<15);			//1<<15: set clock to GPIO
